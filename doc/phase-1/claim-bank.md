...
> Source-cited AI-education claims from public discourse, curated for
> stress-testing against Yisu's three axes. The five chips rendered on
> the landing page (see `components/claim-input.tsx`) are **a subset**
> of what's below; the rest are wild-claim material for extended
> rehearsal, future chip rotations, and the co-design meeting with
> Yisu.
>
> Every claim here has a named author or institutional source. A claim
> without attribution does not belong in this file.
>
> **Axis hook** = which of Yisu's three axes the claim bites hardest
> under. It is a starting hypothesis, not a verdict — the instrument
> may surface pressure on all three.

---

## Chip set (live on the page)

### C1. "Prompting is the new literacy."

- **Canonical form:** _"Prompting is the new literacy."_ — paraphrased
  slogan that circulates across AI-education decks; Ethan Mollick has
  publicly noted the phrase's incoherence (2025-07): *"a lot of what
  people call AI literacy is already out-of-date."*
- **Axis hook:** epistemological. The claim borrows the moral weight
  of "literacy" (an ensemble of reading, writing, inferential
  judgment) and redeploys it on a tool-fluency task (writing good
  prompts). The smuggle: skill-with-an-interface posing as civilizational
  capability.
- **Source:** [Ethan Mollick on AI literacy (X, 2025)](https://x.com/emollick/status/1950725076980035702)

### C2. "AI tutors will replace TAs within five years."

- **Canonical form:** composite of Georgia Tech's Jill Watson
  experiment (sustained since 2016), Khan Academy's Khanmigo
  positioning, and widespread exec commentary. No single author.
- **Axis hook:** jurisdictional. Who controls the tutor–student
...
- **Canonical form:** *"The university essay in its current form
  cannot continue. It's dead, and new assessments need to rise in its
  place."* — assistant professor of educational studies, quoted by
  *Maclean's*, 2025.
- **Axis hook:** mastery pipeline. The essay is the canonical rep for
  sustained inferential writing. If retired, what replaces it — and
...
- **Canonical form:** *"Teachers should not use generative AI as a
  ...
  from relying directly on AI to answer students' questions or provide
  consultation."* — China Ministry of Education, 2025 guidelines on
  AI in primary and secondary schools.
- **Axis hook:** jurisdictional (reverse direction). The claim
  defends rather than annexes teacher jurisdiction. Yisu's frame
...
## Notes for the co-design meeting
